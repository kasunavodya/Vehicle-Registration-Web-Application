...
export default class deleteVehiclePage extends Component {
    ...
    */
    ...
    /**
    * DESCRIPTION       -       The function written to delete the vehicle details.
    * METHOD CALLS      -       setState()
    * API CALL          -       DELETE VEHICLE DETAILS
    */
    onSubmit(e) {
        e.preventDefault();
    ...
    /**
    * DESCRIPTION      -       The function to navigate to the view vehicle details page
    */
